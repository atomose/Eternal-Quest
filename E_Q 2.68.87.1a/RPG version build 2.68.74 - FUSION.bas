...
'-----Aide---------------------------------------------------------------------------------------------------------------------|
    ...
    statictext #3c, "Nous tenons à rappeler que ce jeu est gratuit et ne peux être commercialiser de quelques façons.", 20, 300, 550, 20
    end if
    if version = 2 then
...
'--choixPerso--------------------------------------------------------------------------------------
    ...
    text1$ = "Tyliak, ville natale du royaume d'Attaria, bastion de la famille Esarion "_
            ...
            +"dame édentelé vous demande quelques pièces en échange de sa direction. "_
            +"Agacé, vous lui donné puis elle vous montre du bout du doigt un petit "_
            +"navire de pêche qui s'éloigne du port. "_
            +"Sans attendre vous réquisitionner un navire et vous lancez à sa poursuite..."
    end if
    ...
    text2$ = "La nuit fût longue, le vent glacial. Le navire tangue dangereusement et "_
            ...
            +"faisant retomber plusieurs mètres plus loin. Le mat s'arrache, les planches "_
            ...
            +"Une fois la côte exploré, vous pénétrez dans une forêt dense jusqu'à y trouver "_
            +"une prairie dégagée ou vous vous y installé. "_
            +"Vous y confectionné une tente avec ce que vous avez trouvé en chemin, puis "_
...
[charge]
    ...
    if fileExist(path$,filename$) = 0 then'fileExist(DefaultDir$+"\bmp\map\", file$) then
        ...
        notice " "+chr$(13)+"Pas de fichier : "+ nom$+".txt!"+chr$(13)+"Il faut réinstaller le jeu !"
